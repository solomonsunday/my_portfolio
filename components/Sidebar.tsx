  ...
  return (
    <div>
      ...
      <a
        ...
        href="/static/SolomonSundayCV.pdf"
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 text-green-500 md:w-full">
        <a
          target="_blank"
          rel="noreferrer"
          href="https://github.com/solomonsunday"
        >
        ...
        <a
          target="_blank"
          rel="noreferrer"
          href="https://www.linkedin.com/in/solomonsunday/"
        >
        ...
        <a
          target="_blank"
          rel="noreferrer"
          href="https://stackoverflow.com/users/12233128/solomon-sunday"
        >
      ...
      <button
        ...
        onClick={() => window.open("mailto:schinoyerem007@gmail.com")}
      >
        Email Me
      </button>
      <button
